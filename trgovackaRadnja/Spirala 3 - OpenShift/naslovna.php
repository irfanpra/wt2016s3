...
<BODY>
  ...
  <?php
		...
		{ 
			...
			$vijesti=fopen("$_ENV['OPENSHIFT_DATA_DIR']/vijesti.csv","a+") or die("Problem sa otvaranjem datoteke!");
			fwrite($vijesti,"\n");
...
<div id="novosti">
	...
	<?php
		$vijestiFile=fopen("$_ENV['OPENSHIFT_DATA_DIR']/vijesti.csv",'r') or die ("Datoteka se ne može otvoriti");
		$red;
		$i=0;
		$vijesti2;
