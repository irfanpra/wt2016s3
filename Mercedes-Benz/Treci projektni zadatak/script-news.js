function proba(){
	...
	document.getElementById("sss").innerHTML = "Maidaaaaa";

	//var d[i] = document.getElementsByClass("pro");
...
function setDate()
{
	...
	for(int i = 0; i < dates.length; i++){
		dates[i].innerHTML = "test";
		//dates[i].innerHTML = formatDate(date[i].innerHTML);
	}
}
...
{ 
	...
	var day = hour * 7;
	var week = hour * 30;
	var d = (new Date() ) - (new Date(date_year, date_month, date_day, date_hour, date_min, date_sec));
