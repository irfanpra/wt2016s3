...
Welcome all !!! :)
     ...
     function sortirajPoDatumu($d1,$d2){
     	$vrijeme1=strtotime($d1[0]);
     	$vrijeme2=strtotime($d2[0]);
	...
	print	'<p class="vrijeme">Objavljeno <time class="vrijemeObjave" datetime="'.$nizNovosti[$i][0].'"></time>.</p>';
    print   '<span>'.$nizNovosti[$i][1].'</span>';
    print   '<img src="'.$nizNovosti[$i][2].'" alt="Slika">';
	print   '<p class="vijest">'.$nizNovosti[$i][3].'</p>';
	print '</div>'; 
